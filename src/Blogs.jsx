        ...
        <div>
            ...
            <div className="Portion1">
                ...
                <div className="Description">
                    <h2>Join me on an unforgettable journey through the stunning city of Delhi, where ancient temples, lush landscapes, and vibrant culture converge to create a truly mesmerizing experience.</h2>
                </div>
                <br></br>
                <br></br>
                <br></br>

...
export default function Packages() {
    return (
        <div>
            <h2 align="center" className='Packages_h2'>Popular Packages</h2>
            <h1 align="center" className='Packages_h1'>Checkout Our Packages</h1>
            <p align="center" className='Packages_p'>Discover the diverse beauty of India with our carefully<br></br> curated travel packages! Whether you’re drawn to the <br></br>royal palaces of Rajasthan, the serene backwaters of<br></br> Kerala, or the vibrant culture of cities like Delhi and<br></br> Mumbai, we have the perfect itinerary for you. Our <br></br>packages offer a mix of luxury, adventure, and cultural<br></br> experiences tailored to your preferences.</p>
            <div align="center" className='Package_div1'>
                <div className='div_part_1'>
                    <img className='Package_divs_img' src="https://blog-content.ixigo.com/wp-content/uploads/2013/07/1002982_179273912248246_1780167166_n.jpg"></img>
                </div>
                <div className='div_part_2'>
                    <h1 align="left">EXPERIENCE THE GREAT HOLIDAY ON LAKSHADWEEP BEACH</h1>
                    <h2 align="left">Lakshadweep is a serene archipelago of 36 islands in the Arabian Sea, known for its pristine beaches, vibrant coral reefs, and rich marine life, making it a paradise for nature lovers and adventure enthusiasts.</h2>
                </div>
                <div className='div_part_3'>
                    ...
                    <br></br>
                    <br></br>
                    <h2 align="center">₹19,500 /person</h2>
                    <br></br>
                    <br></br>
            ...
            <div align="center" className='Package_div1'>
                <div className='div_part_1'>
                    <img className='Package_divs_img' src="https://cdn.getyourguide.com/img/tour/5b45d80b0b37f.jpeg/98.jpg"></img>
                </div>
                <div className='div_part_2'>
            ...
            <div align="center" className='Package_div1'>
                <div className='div_part_1'>
                    <img className='Package_divs_img' src="https://upload.wikimedia.org/wikipedia/commons/6/63/Flags_on_Pangong_Lake.jpg?20170630181053"></img>
                </div>
                <div className='div_part_2'>
